 ...
 * @brief File contains C++ implementation of SORT algorithm
 * as described in https://arxiv.org/abs/1602.00763. The official
 * python implementation can be found at https://github.com/abewley/sort
 * 
 * SORT (Simple and online realtime tracking) is an online tracking 
 * algorithm where only detections from the previous and the 
 * current frame are presented to the tracker.
 * 
 * CHANGES FROM REFERENCE
 * 1. Implemented in C++ using `Eigen` library for Array operations
...
class hungarian
{
    ...
    private:
         ...
         * @param coveredRows boolean vector indicating if a row is covered / not
         * @param optimalAssgnVec integer vector containing column index
         * of opHUNGARIAN_ALGORITHMrn void
         */
